...
1. **Foundational questions**: Facts, procedural posture, holding. "What happened in this case?" "What was the court deciding?" "What did the court hold?"
2. **Analytical questions**: Reasoning, policy, implications. "Why did the court reach that result?" "What rule does this establish?" "How does this case differ from [earlier case]?"
3. **Harder territory**: Counterarguments, hypothetical variations, connections to other cases. "What would the dissent say?" "What if the facts were X instead of Y?" "How does this fit with what we learned about [doctrine]?"
